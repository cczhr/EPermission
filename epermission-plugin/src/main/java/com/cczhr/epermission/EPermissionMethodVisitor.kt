...
class EPermissionMethodVisitor(private val classVisitor: ClassVisitor, private val methodVisitor: MethodVisitor, val className: String, val methodName: String) : MethodVisitor(Opcodes.ASM7, methodVisitor) {
    ...
    private fun injectEPermission() {
        ...
        methodVisitor.visitIntInsn(BIPUSH, EPermissionPlugin.permissions.size)
        methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/String")
        EPermissionPlugin.permissions.forEachIndexed { index, permission ->
            methodVisitor.visitInsn(DUP)
            methodVisitor.visitIntInsn(BIPUSH, index)
            methodVisitor.visitLdcInsn(permission)
        ...
        val label3 = Label()
        methodVisitor.visitLabel(label3)
        methodVisitor.visitFrame(Opcodes.F_FULL, 6, arrayOf(className, "[Ljava/lang/String;", Opcodes.INTEGER, "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER), 0, arrayOf())
        methodVisitor.visitVarInsn(ILOAD, 5)
        ...
        methodVisitor.visitMethodInsn(INVOKESTATIC, "androidx/core/content/ContextCompat", "checkSelfPermission", "(Landroid/content/Context;Ljava/lang/String;)I", false)
        methodVisitor.visitInsn(ICONST_M1)
        val label6 = Label()
        methodVisitor.visitJumpInsn(IF_ICMPNE, label6)
        val label7 = Label()
        ...
        methodVisitor.visitLabel(label9)
        methodVisitor.visitLineNumber(63, label9)
        methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null)
        methodVisitor.visitInsn(RETURN)
        val label11 = Label()
        methodVisitor.visitLabel(label11)
        methodVisitor.visitLocalVariable("p", "Ljava/lang/String;", null, label5, label6, 6)
        methodVisitor.visitLocalVariable("this", "L$className;", null, label0, label11, 0)
        methodVisitor.visitLocalVariable("permissions", "[Ljava/lang/String;", null, label1, label11, 1)
        methodVisitor.visitLocalVariable("isGetAllPermissions", "Z", null, label2, label11, 2)
